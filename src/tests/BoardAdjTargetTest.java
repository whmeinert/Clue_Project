...
public class BoardAdjTargetTest {
	...
	public void testTargetsInGarage() {
		// test a roll of 1
		board.calcTargets(board.getCell(14, 20), 1, false);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(1, targets.size());
		assertTrue(targets.contains(board.getCell(10, 18)));	
		
		// test a roll of 3
		board.calcTargets(board.getCell(14, 20), 3, false);
		...
		// test a roll of 4
		board.calcTargets(board.getCell(14, 20), 4, false);
		targets= board.getTargets();
	...
	public void testTargetsInOffice() {
		// test a roll of 1
		board.calcTargets(board.getCell(2, 3), 1, false);
		Set<BoardCell> targets= board.getTargets();
		...
		// test a roll of 3
		board.calcTargets(board.getCell(2, 3), 3, false);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargets(board.getCell(2, 3), 4, false);
		targets= board.getTargets();
	...
	public void testTargetsAtDoor() {
		...
		board.calcTargets(board.getCell(10, 18), 1, false);
		Set<BoardCell> targets= board.getTargets();
		...
		// test a roll of 3
		board.calcTargets(board.getCell(10, 18), 3, false);
		targets= board.getTargets();
		assertEquals(12, targets.size());
		assertTrue(targets.contains(board.getCell(14, 20)));
		...
		// test a roll of 4
		board.calcTargets(board.getCell(10, 18), 4, false);
		targets= board.getTargets();
	...
	public void testTargetsInWalkway1() {
		// test a roll of 1
		board.calcTargets(board.getCell(9, 11), 1, false);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.calcTargets(board.getCell(9, 11), 3, false);
		targets= board.getTargets();
		assertEquals(4, targets.size());
		...
		// test a roll of 4
		board.calcTargets(board.getCell(9, 11), 4, false);
		targets= board.getTargets();
	...
	public void testTargetsInWalkway2() {
		// test a roll of 1
		board.calcTargets(board.getCell(13, 7), 1, false);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(4, targets.size());
		...
		// test a roll of 3
		board.calcTargets(board.getCell(13, 7), 3, false);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargets(board.getCell(13, 7), 4, false);
		targets= board.getTargets();
	...
	public void testTargetsOccupied() {
		...
		board.calcTargets(board.getCell(7, 17), 2, false);
		...
		board.calcTargets(board.getCell(12, 13), 1, false);
